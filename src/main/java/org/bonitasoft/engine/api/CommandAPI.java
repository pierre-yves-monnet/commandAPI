...
public interface CommandAPI {
     ...
     * @param description   Description of the jar file
     * @param jar           Content of the JAR file
     * @return
     * @throws AlreadyExistsException
     * @throws CreationException
     */
    DependencyDescriptor addDependency(String name, String version, String fileName, String description, byte[] jar) throws AlreadyExistsException, CreationException;
     ...
     * @return
     */
    public byte[] getDependencyContent(Long idDependency );
    
    
    /**
     * Update a dependency. Different updates may concern name, description, version, content 
     * @param idDependency
     ...
     * @param idDependency
     */
    void removeDependency(Long idDependency) throws DependencyNotFoundException, DeletionException;
     ...
     * @since 6.0
     */
    SearchResult<DependencyDescriptor> searchDependency(SearchOptions searchOptions) throws SearchException;
